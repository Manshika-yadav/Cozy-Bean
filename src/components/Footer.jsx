            ...
            <div className='bg-black/40 min-h-[400px]'>
                <div className='max-w-7xl mx-auto grid md:grid-cols-3 pb-20 pt-5'>
                    ...
                    <div className='py-8 px-4'>
                        <a href="#" className='font-semibold tracking-widest text-2xl sm:text-3xl font-cursive'>Cozy Bean</a>
                        <p className='pt-4'>From handcrafted beans to cozy experiences — thank you for choosing Cozy Bean.</p>
                    </div>
                    {/* footer links */}
